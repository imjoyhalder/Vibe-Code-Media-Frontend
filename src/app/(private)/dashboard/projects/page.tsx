...
// import { MoreVertical, Edit, Trash2, Eye, Plus, FolderKanban } from "lucide-react";
// import {
//   DropdownMenu,
//   DropdownMenuContent,
//   DropdownMenuItem,
...
//           <p className="text-muted-foreground text-sm mt-1">Manage and showcase your best work.</p>
//         </div>
...
//             <div key={i} className="h-40 rounded-xl bg-muted animate-pulse border" />
//           ))
//         ) : projects.length ? (
...
//               className="group relative cursor-pointer border-border/50 bg-card hover:border-primary/30 hover:shadow-md transition-all duration-200"
//             >
//               <CardHeader className="p-5 pb-2">
//                 <div className="flex items-start justify-between gap-2">
//                   <CardTitle className="text-lg font-bold truncate group-hover:text-primary transition-colors pr-6">
//                     {project.title}
//                   </CardTitle>
                  
//                   {/* Operation Button Positioned Absolute for Better Control */}
...
//                     <Badge key={tag.name} variant="secondary" className="text-[10px] font-medium px-2 py-0">
//                       {tag.name}
//                     </Badge>
//                   ))}
