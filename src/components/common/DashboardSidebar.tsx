...
const navItems = [
  ...
  // { title: "Analytics", href: "/dashboard/a", icon: BarChart3 },
  { title: "Activity", href: "/dashboard/activity", icon: Activity },
  // { title: "Team", href: "/dashboard", icon: Users },
  { title: "ProfileSettings", href: "/dashboard/profile", icon: Settings },
];
      ...
      >
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto px-3">
          {navItems.map((item) => {
            ...
            // Logic: Jodi path exact match hoy athoba 
            // root dashboard bad-e onno kono path startsWith hoy
        ...
        {/* <div className="mt-auto border-t bg-muted/30 p-4">
          {user && (
            <div className="flex items-center gap-3 rounded-xl p-2 transition-colors hover:bg-accent/50">
